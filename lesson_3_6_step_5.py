...
class TestAliens():
    def test_aliens_task(self, browser, links):
        ...
        button_enter = browser.find_element(By.CLASS_NAME, "ember-view.navbar__auth.navbar__auth_login.st-link.st-link_style_button")  # нажимаем на кнопку авторизации на сайте
        button_enter.click()

        input_email = browser.find_element(By.ID, "id_login_email")  # вводим логин
        input_email.send_keys("bimbim@gmail.com")

        input_password = browser.find_element(By.ID, "id_login_password")
        input_password.send_keys("bam_bam")  # вводим пароль
